...
1. Disable the Copilot AI code completion feature which is enabled by default in Visual Studio Code. Do this by clicking going to vs code settings and searching for "disable ai code completions" and check to disable ai code completions or using the robot face on the bottom right of the vs code screen. To understand why The Odin Project thinks you should disable this feature please revisit the Motivation and Mindset lesson section [A note on AI code generation](https://www.theodinproject.com/lessons/foundations-motivation-and-mindset#a-note-on-ai-code-generation).
